...
- The first release uses one simple monthly plan at THB 149. The payment-provider integration is intentionally undecided until the business selects one.
...
- Store payment credentials and implement payment callbacks only after the payment provider is selected and separately approved.

## Current Delivery Order

1. Foundation and public product landing page.
2. Seller accounts, sessions, and password reset.
3. Subscription-plan and payment-provider decision.
